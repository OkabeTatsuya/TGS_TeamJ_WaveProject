...
namespace basecross {
	...
	void ResultStage::OnCreate() {
		try {
			...
			/*ゲームクリアorゲームオーバ*/
			AddGameObject<ImageUI>(Vec3(0.0f), Vec3(800.0f, 150.0f, 1.0f), Vec2(0.0f, 250.0f), float(2.0f), L"FadeBG.png");

			/*タイトルへ*/
			AddGameObject<ImageUI>(Vec3(0.0f), Vec3(250.0f, 100.0f, 1.0f), Vec2(-400.0f, -250.0f), float(2.0f), L"FadeBG.png");

			/*ステージセレクトへ*/
			AddGameObject<ImageUI>(Vec3(0.0f), Vec3(250.0f, 100.0f, 1.0f), Vec2(0.0f, -250.0f), float(2.0f), L"FadeBG.png");
